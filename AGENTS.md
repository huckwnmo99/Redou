...
1. After Claude reviews the disposable Supabase runner, continue the test-foundation roadmap with Phase 1C abort/error-path coverage and the external-service fake catalog on top of the now-executable golden-path harness.
