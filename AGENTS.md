...
1. After Claude reviews the Phase 1C per-paper error fallback tracer, continue Phase 1C with one minimal import/embedding worker failure path unless Claude finds a blocker in the current fallback contract.
