...
1. After Claude reviews the Phase 2A RAG/table eval schema, implement Phase 2B as either JSON schema validation or one runnable disposable-Supabase eval case, depending on Claude's go/stop recommendation.
