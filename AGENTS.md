...
1. After Claude reviews Phase 1B, decide whether the next test-foundation slice should automate a disposable Supabase target runner or add Phase 1C abort/error tests on the same opt-in harness.
