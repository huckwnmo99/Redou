...
1. After Claude reviews the Phase 1C minimal worker failure tracer, either close Phase 1C and move to Phase 2 RAG/table eval schema, or add one import/extraction-specific failure tracer if Claude finds the embedding-worker slice too narrow.
