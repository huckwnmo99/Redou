...
- [`tasks/table-semantics-hardening/`](tasks/table-semantics-hardening/) — 테이블 의미 보존 강화 (Phase 1·2 완료, PR merge 대기. Phase 3 도구 시험은 아래 ledger로 분리)
- [`tasks/tool-ab-adoption/`](tasks/tool-ab-adoption/) — 도구 A/B 도입 (MinerU 3.4 업그레이드 → docling·LangExtract 각각 독립 A/B 후 조건부 채택. 계획 수립 완료)
